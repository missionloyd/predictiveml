...
if __name__ == '__main__':
    ...
    updated_args = [{'model_data_path': './models/tmp/Stadium_Data_Extended_present_elec_kwh_linear_interpolation', 'bldgname': 'Stadium', 'building_file': 'Stadium_Data_Extended.csv', 'y_column': 'present_elec_kwh', 'imputation_method': 'linear_interpolation', 'model_type': 'xgboost', 'feature_method': 'lassocv', 'n_feature': 1, 'time_step': 24, 'header': ['ts', 'present_elec_kwh', 'temp_c', 'rel_humidity_%', 'surface_pressure_hpa', 'cloud_cover_%', 'direct_radiation_w/m2', 'precipitation_mm', 'wind_speed_ground_km/h', 'wind_dir_ground_deg'], 'data_path': './clean_data_extended', 'add_feature': ['temp_c', 'rel_humidity_%', 'surface_pressure_hpa', 'cloud_cover_%', 'direct_radiation_w/m2', 'precipitation_mm', 'wind_speed_ground_km/h', 'wind_dir_ground_deg'], 'min_number_of_days': 365, 'exclude_column': ['present_co2_tons'], 'n_fold': 5, 'split_rate': 0.8, 'minutes_per_model': 2, 'memory_limit': 102400, 'save_model_file': False, 'save_model_plot': True, 'path': '.', 'save_preprocessed_file': False}]
