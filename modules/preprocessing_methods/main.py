...
def preprocessing(
  ...
  for name, group in groups:
    ...
    if col_data[y_column].count() >= min_number_of_days * 24 and y_column not in exclude_columns:
      ...
      updated_arg = (building_file, y_column, imputation_method, model_data_path, bldgname)
